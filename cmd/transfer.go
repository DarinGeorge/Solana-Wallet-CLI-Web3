...
var transferCmd = &cobra.Command{
	Use:   "transfer",
	Short: "Transfers Solana to a specified recipient.",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("View transaction via Solana Explorer here: https://explorer.solana.com/tx/" + txhash + "?cluster=devnet")
	},
}
